In the map canvas, you should see that all the features of the *Raleigh_Downtown* layer are represented with a simple fill style, with hollow polygons with a dashed blue outline.
